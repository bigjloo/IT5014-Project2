...
namespace TicketSystem
{
    class Program
    {
        static void Main()
        {
            ...
            Ticket ticket_1 = AppLogic.CreateTicket(staffID_1, description_1, ticketStats, ticketContainer);
            ...
            Ticket ticket_2 = AppLogic.CreateTicket(staffID_2, description_2, creatorName_2, email_2, ticketStats, ticketContainer);

            // Ticket #3 with password change request
            string staffID_3 = "JANED";
            string description_3 = "Password change";
            Ticket ticket_3 = AppLogic.CreateTicket(staffID_3, description_3, ticketStats, ticketContainer);

            AppLogic.DisplayTicketStatsAndInformation(ticketStats, ticketContainer);
